...
static const uint8_t base16[16][3] = {
    {0x1a, 0x1a, 0x1a}, {0xed, 0x56, 0x7a}, {0x02, 0xbf, 0x87}, {0xec, 0xcc, 0x68},
    {0x75, 0x71, 0xf9}, {0xf7, 0x80, 0xe2}, {0x6e, 0xef, 0xc0}, {0xd0, 0xd0, 0xd0},
    {0x67, 0x67, 0x67}, {0xff, 0x8d, 0xa1}, {0x5a, 0xee, 0xad}, {0xf5, 0xdf, 0xa0},
    {0x9b, 0x98, 0xff}, {0xff, 0x9c, 0xe8}, {0xa5, 0xf5, 0xd4}, {0xff, 0xfd, 0xf5},
};
